...
核心功能：围绕当前专题回答问题，解释专题内容与资源关系，辅助学习路径与进度理解。

设计原则：

- 上下文感知：问题必须绑定 `topic_id`，回答带专题上下文。
- 有据可查：回答引用资源/提交来源，避免”无依据建议”。
- 只读优先：学习助手不修改业务数据。
...
- 资源定位：例如”和神经网络相关的资源有哪些？”
- 进度查询：例如”我目前提交过哪些成果？还缺什么？”

教师场景：

- 专题回顾：快速理解当前专题说明、资源和提交覆盖情况
- 学习跟踪：查看某专题当前提交和评价进度
...
- 编辑专题时：改写专题说明、补齐资源说明文本并落库。
- 发布前：检查是否缺少关键资源、资源类型单一、截止日期不合理等。
