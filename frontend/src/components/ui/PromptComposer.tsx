        ...
        <div className="mt-3 flex flex-col gap-3 border-t border-white/10 pt-3 sm:flex-row sm:items-center sm:justify-between">
          {showModelSelect ? (
            <div className="relative">
              ...
              >
                <span className="flex h-8 w-8 shrink-0 items-center justify-center overflow-hidden rounded-xl border border-white/10 bg-gray-800 text-gray-200">
                  <currentModel.Logo />
                </span>
                    ...
                    <div className="mt-1 flex flex-col gap-1">
                      {AGENT_MODELS.map((model) => {
                        ...
                        return (
                          ...
                          >
                            <span className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center overflow-hidden rounded-xl border border-white/10 bg-gray-800 p-0.5">
                              <model.Logo />
                            </span>
                            <span className="min-w-0 flex-1">
