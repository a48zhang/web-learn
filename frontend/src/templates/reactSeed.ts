...
export const reactSeed: Record<string, string> = {
  ...
  'src/App.tsx': [
    'function App() {',
    '  return (',
    '    <div className="max-w-screen-md mx-auto my-8 font-sans p-6">',
    '      <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Hello, world</h1>',
    '      <p className="mt-4 text-gray-600 dark:text-gray-400">',
    '        Edit <code className="bg-gray-100 dark:bg-gray-800 px-1.5 py-0.5 rounded text-sm font-mono">src/App.tsx</code> and save to reload.',
    '      </p>',
    '    </div>',
    '  );',
    '}',
